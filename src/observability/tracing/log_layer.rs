    ...
    S: Subscriber + for<'a> LookupSpan<'a>,
{
    let LoggerConfig {
        ...
        logging_max_file_size: logging_file_limit,
        logging_max_history: logging_file_max_age,
        logging_max_file_count: logging_file_max_count,
        logging_enable_compression: enable_zip,
        headers_filter: _,
    } = logger_config;
