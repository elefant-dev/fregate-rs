mod app_config_from_env {
    ...
    fn test_load_from() {
        ...
        std::env::set_var("TEST_LOGGING_FILE_INTERVAL", "100");
        std::env::set_var("TEST_LOGGING_FILE_LIMIT", "2");
        std::env::set_var("TEST_LOGGING_FILE_MAX_AGE", "10");
        std::env::set_var("TEST_LOGGING_FILE_MAX_COUNT", "1");
        std::env::set_var("TEST_LOGGING_FILE_ENABLE_ZIP", "true");
        std::env::set_var("TEST_LOGGING_PATH", "./a/b/c");
        ...
        assert_eq!(logger.logging_file_interval, Some(Duration::from_secs(100)));
        assert_eq!(logger.logging_file_limit, Some(2));
        assert_eq!(logger.logging_file_max_age, Some(Duration::from_secs(10)));
        assert_eq!(logger.logging_file_max_count, Some(1));
